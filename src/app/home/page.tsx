...
export default function HomePage() {
  ...
  const pending = allActivities.filter((a) => a.status === "Pendiente").length;
  const inProgress = allActivities.filter((a) => a.status === "En proceso").length;
  const done = allActivities.filter((a) => a.status === "Terminado").length;
